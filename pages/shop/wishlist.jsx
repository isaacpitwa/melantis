                                                ...
                                                <td className="price-col">
                                                    {
                                                        product.stock == 0 ?
                                                            ...
                                                            product.minPrice == product.maxPrice ?
                                                                <div className="product-price d-inline-block mb-0">Ugx{ product.minPrice.toFixed( 2 ) }</div>
                                                                :
                                                                product.variants.length == 0 ?
                                                                    ...
                                                                    :
                                                                    <div className="product-price d-inline-block mb-0">Ugx{ product.minPrice.toFixed( 2 ) }&ndash;Ugx{ product.maxPrice.toFixed( 2 ) }</div>
                                                    }
                                                </td>
