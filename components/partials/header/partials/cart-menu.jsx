    ...
    return (
        <div className="dropdown cart-dropdown">
            <ALink href="/shop/cart" className="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                ...
                <span className="cart-count font-weight-bolder bg-secondary">{ cartQtyTotal( cartlist ) }</span>
            </ALink>
                    ...
                    0 === cartlist.length ?
                        ...
                        <>
                                        ...
                                        <div className="product-cart-details">
                                            ...
                                            <span className="cart-product-info">
                                                <span className="cart-product-qty">{ item.qty } </span>
                                                 x Ugx{ item.sale_price ? item.sale_price.toFixed( 2 ) : item.price.toFixed( 2 ) }
                                            </span>
                                        </div>
                            ...
                            <div className="dropdown-cart-total">
                                ...
                                <span className="cart-total-price">Ugx{ cartPriceTotal( cartlist ).toLocaleString( undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 } ) }</span>
                            </div>
