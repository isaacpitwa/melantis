                ...
                product.stock == 0 ?
                    <div className="product-price">
                        <span className="out-price">
                            {
                                minPrice == maxPrice ?
                                    <span>Ugx{ product.price.toFixed( 2 ) }</span>
                                    :
                                    <span>ugx{ minPrice.toFixed( 2 ) }&ndash;Ugx{ maxPrice.toFixed( 2 ) }</span>
                            }
                        </span>
                    </div>
                    :
                    minPrice == maxPrice ?
                        <div className="product-price">Ugx{ minPrice.toFixed( 2 ) }</div>
                        :
                            ...
                            { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                <div>
                                    ...
                                    <div ref={ setCollapsibleElement } style={ { overflow: 'hidden' } }>
                                        <div className="product-price">
                                            Ugx{ selectedVariant.price ? selectedVariant.price.toFixed( 2 ) : 0 }
                                        </div>
                                    </div>
                                </div>
                            ) }
